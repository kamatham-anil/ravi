...
/**
 * Siddhi Function for 2967.
 */
public class 2967Function extends FunctionExecutor {

    // conversion equivalencies
    private static final double KILOMETERS_PER_MILE = 1.609344;

    /**
     * The initialization method for 2967, this method will be called before the other methods.
     *
       ...
       //Sample code to convert mile to km
        ...
        if (!((attributeType == Attribute.Type.DOUBLE)
            ...
            throw new ExecutionPlanValidationException("Invalid parameter type found " +
                    "for the argument of 2967 function, " +
    ...
    protected Object execute(Object data) {
        ...
        if (data != null) {
            ...
            throw new ExecutionPlanRuntimeException("Input to the 2967 function cannot be null");
        }
        return null;
    }
